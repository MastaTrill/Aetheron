...
console.log('\n🔍 2. Syntax Validation');
const syntaxCheckFiles = coreFiles.filter(f => f.endsWith('.js'));
...
const exportChecks = [
  { file: 'gaming-sdk.js', exports: ['GameAssetManager', 'PlayToEarnSystem', 'GameFiIntegration'] },
  { file: 'ai-defi.js', exports: ['PortfolioManager', 'RiskAssessmentEngine', 'SmartContractAuditor'] },
  { file: 'layer3-scaling.js', exports: ['MetaTransactionSystem', 'BatchTransactionProcessor', 'IntentBasedSystem'] },
  { file: 'privacy-compliance.js', exports: ['EnhancedZKPrivacy', 'RegulatoryComplianceEngine'] },
  { file: 'rwa-tokenization.js', exports: ['FractionalOwnershipSystem', 'RevenueSharingSystem'] },
  { file: 'social-defi.js', exports: ['SocialTradingSystem', 'ReputationBasedLendingSystem'] },
  { file: 'mobile-enhancements.js', exports: ['WalletConnectSystem', 'BiometricAuthSystem'] },
  { file: 'advanced-analytics.js', exports: ['RealTimeMonitoringSystem', 'PredictiveMaintenanceSystem'] },
  { file: 'developer-experience.js', exports: ['PluginMarketplaceSystem', 'MultiLanguageSDKSystem'] }
];
